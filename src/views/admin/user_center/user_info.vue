  ...
  <div class="gvb_user_info_bg">
    <a-modal title="绑定邮箱" v-model:visible="bindEmailVisible">
      ...
      <template #footer>
        ...
        <a-button type="primary" v-if="step === 0" @click="sendEmailCode"
          >下一步</a-button
        >
        <a-button type="primary" v-if="step === 1" @click="bindEmail"
          >完成</a-button
        >
      </template>
    </a-modal>
    ...
    >
      ...
      >
        ...
        >
          <a-input
            v-model:value="pwdState.old_pwd"
            placeholder="原密码"
          ></a-input>
        </a-form-item>
        <a-form-item
    ...
    <div class="gvb_user_info_view">
      <div class="user_head">个人信息</div>
      <div class="body user_info_view">
        <a-form :label-col="{ span: 2 }" :wrapper-col="{ span: 22 }">
          <a-form-item label="昵称">
            <a-input
              @blur="updateUserInfo('nick_name')"
              placeholder="昵称"
              v-model:value="userInfo.nick_name"
              class="user_ipt"
            ></a-input>
          </a-form-item>
          <a-form-item label="我的签名">
            <a-textarea
              @blur="updateUserInfo('sign')"
              placeholder="我的签名"
              v-model:value="userInfo.sign"
              class="user_ipt"
          ...
          <a-form-item label="我的博客">
            <a-input
              @blur="updateUserInfo('link')"
              placeholder="我的博客"
              v-model:value="userInfo.link"
              class="user_ipt"
            ></a-input>
          </a-form-item>
      ...
      <div class="user_head">成就勋章</div>
      <ul class="body medal">
        <li>
          <img
            src="https://i0.hdslb.com/bfs/face/21fdd1bcd9ad1b52d5725026d71c185a68681644.png"
            alt=""
          />
        ...
        <li>
          <img
            src="https://i0.hdslb.com/bfs/face/51ca16136e570938450bca360f28761ceb609f33.png"
            alt=""
          />
        ...
        <li>
          <img
            src="https://i0.hdslb.com/bfs/face/89491e6cee3b1c88292b618a58703ab614665f66.png"
            alt=""
          />
      ...
      <div class="body actions">
        ...
        <a-button type="primary" @click="updatePasswordVisible = true"
          >修改密码</a-button
        >
        <a-popconfirm title="确定要注销退出吗" okText="确定" cancelText="取消" @confirm="logout">
