<template>
  <div class="gvb_container">
    ...
    <a-modal
      v-model:visible="data.modalUpdateVisible"
      title="编辑用户"
      @ok="update"
    >
      <a-form
      ...
      >
        ...
        >
          <a-input
            v-model:value="formUpdateState.nick_name"
            placeholder="昵称"
          />
        </a-form-item>
        <a-form-item
    ...
    <div class="gvb_search">
      ...
      <a-select class="gvb_select" v-model:value="page.role" style="width: 200px" allowClear="true" @change="onSearch" :options="roleOptions" placeholder="选择权限"></a-select>
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-if="column.key === 'action'">
            ...
            >
              <a-button class="gvb_table_action delete" type="danger"
                >删除</a-button
              >
            </a-popconfirm>
          </template>
