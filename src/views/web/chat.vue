      ...
      <div class="gvb_base_container" :style="{height: data.allHeight}">
        <div class="gvb_inner_container">
          ...
          <div class="gvb_chat_menu">
            <span @click="uploadTodo"><i class="fa fa-cloud-upload"></i></span>
            <span @click="uploadTodo"><i class="fa fa-file-image-o"></i></span>
            <span @click="uploadTodo"><i class="fa fa-file-audio-o"></i></span>
          </div>
          <div class="gvb_chat_footer">
            <div class="gvb_chat_mask" v-if="data.mask">
              <a-button type="paimary" class="connect_chat_btn" @click="websocketConnect">进入聊天室</a-button>
            </div>
...
import { message } from "ant-design-vue";
  ...
  async function getData() {
    ...
    // 加载聊天记录
    let res = await chatApi({limit: 50})
